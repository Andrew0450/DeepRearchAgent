...
_SEARCH_QUERIES_B1 = [
    ...
    '{english} market size industry report',
]

# ---- 方向 B2: 产品驱动 ----
_PROMPT_B2 = """你是产品驱动型调研数据提取器。按三层框架提取数据。

## 调研主题
{topic}

## 三层调研框架
第一层：产品本身的市场（直接市场+父类市场+核心器件市场）
第二层：应用场景的市场（上游+下游+消费者+渠道）
第三层：宏观环境（政策+技术趋势+国际市场）
...
_SEARCH_QUERIES_B2 = [
    ...
    '{primary} 同类产品 替代品',
    '{primary} 应用场景 消费者',
    '{english} market size alternatives',
]
...
### 模板B2（产品驱动型）
产品与行业定义 → 产品直接市场 → 应用场景市场 → 产业链全景 → 竞争格局 → 驱动因素 → 风险挑战 → 趋势判断
